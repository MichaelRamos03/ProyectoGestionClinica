 ...
 * @author karla
 */
public class PruebaVistaPanel extends javax.swing.JFrame {

    /**
     * Creates new form PruebaVistaPanel
     */
    public PruebaVistaPanel() {
        initComponents();
         this.setLocationRelativeTo(this);
        this.PanelPrueba.setBorder(new Fondo("/imagenes/ImagenMedicamentos.jpg"));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PruebaVistaPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PruebaVistaPanel().setVisible(true);
            }
        });
    }
